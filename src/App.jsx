...
export default function App (){
  const Box = () => {
    return (
      <div className="box">
        <div className="backgroundhero-wrapper">
          <img className="backgroundhero" alt="Backgroundhero" src="https://www.designyourway.net/blog/wp-content/uploads/2019/02/aesthetic-wallpaper-1.jpg" />
        </div>
        <div className="box">
    ...
    <div className="home-wrapper">
        <div className="home">
          <div className="hola-andrew-listo-p">Shyaam</div>
      ...
      <div className="thumbnail-wrapper">
        <img className="thumbnail" alt="Thumbnail" src="1st.jpeg" />
      </div>
      <div className="thumbnail-wrapper1">
        <img className="thumbnail1" alt="Thumbnail" src="2.jpeg" />
      </div>
      <div className="thumbnail-wrapper2">
        <img className="thumbnail2  " alt="Thumbnail" src="3.jpeg" />
      </div>
    </div>
    ...
    return (
      <div className="label">
        <div className="logo-wrapper">
          <div className="logo">
            <span className="text-wrapper1" color='red'>Shyaam</span>
            <span className="span">&nbsp;</span>
            <span className="text-wrapper1">s</span>
  ...
  <path fill-rule="evenodd" clip-rule="evenodd" d="M15.4781 15.2237H12.9503V11.2656C12.9503 10.3218 12.9331 9.10777 11.6359 9.10777C10.3198 9.10777 10.1177 10.1359 10.1177 11.1974V15.2237H7.59039V7.08468H10.0165V8.19678H10.0503C10.3881 7.55699 11.2132 6.88239 12.4438 6.88239C15.0052 6.88239 15.4781 8.56819 15.4781 10.7595V15.2237ZM4.73971 5.97214C3.92893 5.97214 3.27283 5.31495 3.27283 4.50521C3.27283 3.69619 3.92893 3.03899 4.73971 3.03899C5.54848 3.03899 6.20565 3.69619 6.20565 4.50521C6.20565 5.31495 5.54848 5.97214 4.73971 5.97214ZM3.4739 15.2237H6.00359V7.08466H3.4739V15.2237ZM16.7375 0.690918H2.20412C1.50964 0.690918 0.945312 1.2414 0.945312 1.91979V16.5149C0.945312 17.1942 1.50964 17.7455 2.20412 17.7455H16.7375C17.4332 17.7455 17.9999 17.1942 17.9999 16.5149V1.91979C17.9999 1.2414 17.4332 0.690918 16.7375 0.690918Z" fill="#AF48FF"/>
      ...
      <div className="portfolio-of-UI-desi-wrapper">
        <p className="portfolio-of-UI-desi">
          <span className="text-wrapper">I’m Shyaams </span>
      ...
      <div className="but-first-watch-my-c-wrapper">
        ...
        <div className="but-first-watch-my">Shyaams@drngpit.ac.in</div>
      </div>
      ...
      <div className="portfolio-of-UI-desi-wrapper3">
        <div className="portfolio-of-UI-desi3">Hello !,I'm Shyaam</div>
      </div>
  ...
  return (
    <div className="image">
      <div className="face-photo-wrapper">
        {/* <img className="face-photo" alt="" src="NGP-2707\public\face-photo.png" /> */}
      </div>
    </div>
  );
};
